          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {rows.map((r, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ flex: 1, background: 'rgba(255,255,255,0.09)', borderRadius: 4, height: 22, position: 'relative', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.06)' }}>
                  <div style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: 'rgba(15,23,42,0.97)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 18, padding: '1.5rem', maxWidth: 620, width: '90%', position: 'relative' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={() => setReceiptModal(null)} style={{ background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.12)', color: '#fff', borderRadius: 8, padding: '5px 10px', cursor: 'pointer', fontSize: 14 }}>✕</button>
              </div>
            </div>
...
function InstructorTab() {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      {/* Photo section */}
      <div style={{ background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '1.5rem', marginBottom: '1.5rem' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <div className="field" style={{ textAlign: 'left', marginTop: '1rem', marginBottom: 0 }}>
          ...
          <textarea
            ...
            rows={4}
            style={{ fontSize: 13, resize: 'vertical', background: 'rgba(255,255,255,0.09)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10, padding: '10px 14px', color: '#fff', width: '100%', fontFamily: 'inherit' }}
          />
        </div>
