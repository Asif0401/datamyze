    ...
    <div style={{ position: 'relative', marginBottom: '2rem', borderRadius: 22 }}>
      ...
      <div className="pro-border-anim" style={{ borderRadius: 22, padding: '1.5px', boxShadow: '0 16px 60px rgba(246,211,101,0.18),0 4px 20px rgba(0,0,0,0.5)' }}>
        <div style={{ background: 'linear-gradient(145deg,#0c1e38 0%,#111827 55%,#0d1a2e 100%)', borderRadius: 21, padding: '2rem 2.2rem 1.6rem', position: 'relative', overflow: 'hidden' }}>
          ...
          <button onClick={onDismiss} style={{ position: 'absolute', top: 14, right: 14, zIndex: 2, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.45)', borderRadius: 8, width: 28, height: 28, cursor: 'pointer', fontSize: 13, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✕</button>
    ...
    <div className="page">
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.9rem' }}>
          {[
            ...
            <div key={i} style={{
              ...
              {/* Mini progress bar */}
              <div style={{ height: 3, borderRadius: 99, background: 'rgba(255,255,255,0.07)', marginTop: 6 }}>
      ...
      <div className="dash-fadein card" style={{ animationDelay: '.15s', marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.2rem', flexWrap: 'wrap', gap: 8 }}>
          ...
          <span style={{ fontSize: 11, color: 'var(--muted)', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 20, padding: '3px 12px' }}>
            {score}% ready
          </span>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
          ...
          <div className="card dash-fadein" style={{ animationDelay: '.2s' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', flexWrap: 'wrap', gap: 8 }}>
              ...
              <span style={{ fontSize: 11, color: 'var(--muted)', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 20, padding: '2px 10px' }}>Last 13 weeks</span>
            </div>
          ...
          <div className="card dash-fadein" style={{ animationDelay: '.25s' }}>
            ...
            <div className="skills-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.9rem' }}>
              {[
                ...
                <div key={s.label} style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid var(--border)', borderRadius: 12, padding: '0.9rem', animationDelay: s.delay }}>
              ...
              {[
                ...
                <div key={s.step} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '10px 0', borderBottom: i < 3 ? '1px solid rgba(255,255,255,0.05)' : 'none' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
                    ...
                    {i < 3 && <div style={{ width: 1, height: 16, background: 'rgba(255,255,255,0.06)', marginTop: 3 }} />}
                  </div>
                  {/* Content */}
          ...
          <div className="card dash-fadein" style={{ animationDelay: '.2s' }}>
            ...
            <div className="week-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.7rem', marginBottom: '0.9rem' }}>
              {[
                ...
                <div key={s.label} style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid var(--border)', borderRadius: 11, padding: '0.8rem', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'rgba(255,255,255,0.08)', borderRadius: 10, border: '1px solid var(--border)' }}>
