            ...
            <div style={{ display: 'flex', gap: 10, marginTop: '1rem', flexWrap: 'wrap' }}>
              ...
              {github && (
                <a href={github} target="_blank" rel="noopener noreferrer" style={{
                  display: 'flex', alignItems: 'center', gap: 5, fontSize: 12,
                  color: '#cdd6f4', background: 'rgba(255,255,255,0.08)',
      ...
      <div style={CARD}>
        ...
        {tab === 'security' && (
          <div style={{ maxWidth: 500 }}>
            ...
            <div style={{ padding: '1rem 1.2rem', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 10, marginBottom: '1.5rem' }}>
